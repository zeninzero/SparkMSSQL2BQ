...
object SparkPostgres2BQ {
  ...
  def main(args: Array[String]) {
    ...
    val jdbcData = JdbcClient.getTableDetails(hanaDriver,hanaURL,hanaUserName,hanaPassword,options.get('hanaDbTable).get.toString,whereClause)
